...
def test_get_operations():
    assert utils.get_operations(operations_list) == [
        {
            "id": 441945886,
            "state": "EXECUTED",
...
def test_get_executed_only():
    assert utils.get_executed_only(get_operations(operations_list)) == [
        ...
        {'id': 633268359, 'state': 'EXECUTED', 'date': '2019-07-12T08:11:47.735774',
         ...
         'description': 'Перевод организации', 'from': 'Visa Gold 3589276410671603', 'to': 'Счет 96292138399386853355'},
        ...
        {'id': 917824439, 'state': 'EXECUTED', 'date': '2019-07-18T12:27:13.355343',
         ...
         'to': 'МИР 2956603572573342'}, {'id': 736942989, 'state': 'EXECUTED', 'date': '2019-09-06T00:48:01.081967',
...
def test_sort_by_date():
    assert utils.sort_by_date(get_executed_only(get_operations(operations_list))) == [
        {'id': 863064926, 'state': 'EXECUTED', 'date': '2019-12-08T22:46:21.935582',
         'operationAmount': {'amount': '41096.24', 'currency': {'name': 'USD', 'code': 'USD'}},
         'description': 'Открытие вклада', 'to': 'Счет 90424923579946435907'},
        {'id': 114832369, 'state': 'EXECUTED', 'date': '2019-12-07T06:17:14.634890',
        ...
        {'id': 242885401, 'state': 'EXECUTED', 'date': '2019-07-08T00:08:32.986663',
         'operationAmount': {'amount': '10083.68', 'currency': {'name': 'USD', 'code': 'USD'}},
         'description': 'Перевод со счета на счет', 'from': 'Счет 38427597486442637521',
         'to': 'Счет 83889757415570699323'}, {'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364',
        ...
        {'id': 34148726, 'state': 'EXECUTED', 'date': '2018-11-23T23:52:36.999661',
         ...
         'to': 'Maestro 8045769817179061'}, {'id': 720751477, 'state': 'EXECUTED', 'date': '2018-11-08T08:21:45.902633',
        ...
        {'id': 743278119, 'state': 'EXECUTED', 'date': '2018-10-15T08:05:34.061711',
         'operationAmount': {'amount': '51203.12', 'currency': {'name': 'USD', 'code': 'USD'}},
         'description': 'Перевод с карты на карту', 'from': 'MasterCard 1435442169918409',
         'to': 'Maestro 7452400219469235'}, {'id': 542678139, 'state': 'EXECUTED', 'date': '2018-10-14T22:27:25.205631',
        ...
        {'id': 280743947, 'state': 'EXECUTED', 'date': '2018-09-27T14:26:24.629306',
         ...
         'description': 'Перевод организации', 'from': 'Счет 23177857685058835559', 'to': 'Счет 56363465303962313778'},
        ...
        {'id': 232222017, 'state': 'EXECUTED', 'date': '2018-07-06T22:32:10.495465',
         'operationAmount': {'amount': '37160.27', 'currency': {'name': 'руб.', 'code': 'RUB'}},
         'description': 'Перевод с карты на карту', 'from': 'Visa Classic 4062745111784804',
         'to': 'Maestro 8602249654751155'}, {'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572',
        ...
        {'id': 361044570, 'state': 'EXECUTED', 'date': '2018-03-02T02:03:11.563721',
         ...
         'description': 'Перевод организации', 'from': 'Счет 96008924215040031147', 'to': 'Счет 30377212495530283001'},
        {'id': 988276204, 'state': 'EXECUTED', 'date': '2018-02-22T00:40:19.984219',
         'operationAmount': {'amount': '71771.90', 'currency': {'name': 'USD', 'code': 'USD'}},
         'description': 'Перевод организации', 'from': 'MasterCard 4956649687637418',
         'to': 'Счет 90562872508279542248'},
        ...
        {'id': 407169720, 'state': 'EXECUTED', 'date': '2018-02-03T14:52:08.093722',
         'operationAmount': {'amount': '67011.26', 'currency': {'name': 'руб.', 'code': 'RUB'}},
         'description': 'Перевод с карты на карту', 'from': 'MasterCard 4047671689373225',
         'to': 'Maestro 3806652527413662'}, {'id': 893507143, 'state': 'EXECUTED', 'date': '2018-02-03T07:16:28.366141',
...
def test_last_five_operations():
    assert utils.last_five_operations(sort_by_date(get_executed_only(get_operations(operations_list)))) == [
        {'id': 863064926, 'state': 'EXECUTED', 'date': '2019-12-08T22:46:21.935582',
         'operationAmount': {'amount': '41096.24', 'currency': {'name': 'USD', 'code': 'USD'}},
         'description': 'Открытие вклада', 'to': 'Счет 90424923579946435907'},
        {'id': 114832369, 'state': 'EXECUTED', 'date': '2019-12-07T06:17:14.634890',
...
def test_hide_number():
    assert utils.hide_number("Счет 72731966109147704472") == "Счет **4472"
    assert utils.hide_number("Visa Gold 5999414228426353") == "Visa Gold **5999 41** **** 6353"
    assert utils.hide_number("Visa Platinum 1246377376343588") == "Visa Platinum **1246 37** **** 3588"
    assert utils.hide_number("Maestro 3928549031574026") == "Maestro **3928 54** **** 4026"
    assert utils.hide_number("MasterCard 4047671689373225") == "MasterCard **4047 67** **** 3225"
    assert utils.hide_number("Visa Classic 4195191172583802") == "Visa Classic **4195 19** **** 3802"
